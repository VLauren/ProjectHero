...
//
// TODO
// - revisar sistema de guardado
//		- leer y comentar blueprints
//		- listar que falta por implementar y por diseñar
// - diseñar lo que falta del sistema de guardado
// - Sistema de estados 2.0
//		- mostrar energía
//		- desactivar habilidad
//		- esquivar cuesta energía
//		- efecto ralentizar tiempo al esquivar/generar copia
//		- slot inicial: 0, resto slot 1
//		- guardar estado con esquiva
//		- energia ~1/2 carga 1, sino, carga 0
// - arreglo de particulas que se acumulan
// - logica unificada de time dilations para prevenir bugs (hit, esquive, state load)
//		- listar donde estan los casos
//			- Hit: PHGame.cpp metodo FreezeFrames
//				- 3 frames a 0.1f
//			- Muerte: MainCharBP Graph > Menus Pausa/Muerte > Evento On Death
//				- 0.4s a 0.2 + 0.2 
//			- Esquivar: MainCHar BP Graph > Particulas > On Ground/Air Dodge
//				- 0.05s a 0.4
//		- cambiar/añadir evento a frames en lugar de tiempo
//		- configurar los eventos
// - arreglillos
//		- ataques base deben empujar menos (datos de ataques en tabla?)
// ---------------------------------------------------------------
//		- aumentar cambio de direccion entre ataques
//		- borrar misiles al cargar estado
//		- borrar efectos especiales al cargar
//		- borrar recogibles al cargar estado
//		- animacion muerte -> no muerte: instant
// - fx pies correr
// - brillo de pelo segun energía
// - guardar/cargar vida del enemigo
//		- añadir vida a EnemyStateInfo
//		- crear método de spawn enemigo a partir de un EnemyStateInfo
//		- guardar vida de enemigo
//		- añadir vida al método de spawn de enemigo
// - arreglar el rising attack
//		- comparar con el salto
//		- arreglarlo
// - fijar objetivo con cam, no con personaje
// - tracking vertical moviendo el personaje a la altura correcta
// - reorganizar blueprint mainchar (o todos!)
// - Organizar archivos y carpetas del proyecto
// - sistema de spawn de enemigos con csv
// - diseñar jefe
// - planear implementación de jefe
// - implementar jefe
//
// BACKLOG
// - test fijar objetivo funciona dejando pulsado (R1 o R2)
// - review fall attack
// - datos de ataques con tabla?
// - humo low poly
// - particulas de pasos
// - pruebas material fade out/in cargar estado (alpha global o algo asi)
// - pelo apagado/encendido
// - guardar / cargar energia recogible
// - rework blueprint animacion	
// - 
//
// =======================
// [old list]
...
//		- vulnerable
// - pulido
//		- arreglar rising attack para que sea mas parecido a saltar (baja muy rapido)
//		- facilitar air combos con ajuste vertical
// - sistema de guardado
//		- arreglar
//
